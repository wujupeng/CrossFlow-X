...
print("=" * 60)
print("CrossFlow-X Physical mDNS Cross-Platform Test (Windows 11)")
print("=" * 60)
...
print()
print(">>> NOW RUN ON macOS: ./run_macos_full_test.sh <<<")
print(">>> Or: bash run_macos_full_test.sh <<<")
print()
...
print()
print("=" * 60)
print("Test Summary (Windows Side)")
print("=" * 60)
print(f"Total time: {total_time:.0f} ms")
print(f"Total discoveries: {len(listener.discoveries)}")

win_discoveries = [d for d in listener.discoveries if "Win" in d["service_name"]]
mac_discoveries = [d for d in listener.discoveries if "Mac" in d["service_name"] or "mac" in d.get("properties", {}).get("plat", "")]

print(f"Windows services discovered: {len(win_discoveries)}")
print(f"macOS services discovered: {len(mac_discoveries)}")

evidence = {
    "test_type": "Cross-Platform mDNS Interoperability (Windows Side)",
    "windows_side": {
    ...
    "summary": {
        ...
        "macos_discoveries": len(mac_discoveries),
    }
}
...
if mac_discoveries:
    print("\n*** Test A SUCCESS: Windows listener discovered macOS announcer! ***")
else:
    print("\n*** Test A: No macOS announcer discovered yet ***")
